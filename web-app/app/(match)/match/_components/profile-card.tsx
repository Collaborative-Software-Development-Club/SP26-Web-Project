...
export function ProfileCard({
  ...
  return (
    <div className="min-h-3/4 bg-zinc-50 dark:bg-black p-4 md:p-8 font-sans flex flex-col items-center">
      ...
      <div className="w-full max-w-4xl bg-white dark:bg-zinc-900 rounded-[2rem] shadow-xl border border-zinc-100 dark:border-zinc-800 overflow-hidden relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-0 relative z-10">
          ...
          <div className="w-full md:col-span-7 p-6 md:p-8 flex flex-col justify-between">
            {/* [ready] Header */}
            <div className="flex justify-between items-start mb-2">
              ...
              {/* <div
                  className={`flex flex-col items-center justify-center w-16 h-16 rounded-2xl border-[3px] ${getMatchColor(matchScore)} backdrop-blur-sm`}
                >
                  <span className="text-xl font-bold">{matchScore}%</span>
                  <span className="text-[9px] uppercase font-bold tracking-wide opacity-80">
                    Match
                  </span>
                </div> */}
            </div>
              ...
              <div className="col-span-2">
                ...
                <div className="flex flex-wrap gap-2">
                  {profile.hobbies.map((hobby) => (
                    <span
                      key={hobby}
                      className="px-4 py-1.5 rounded-full bg-zinc-100 dark:bg-zinc-800 text-zinc-700 dark:text-zinc-300 text-sm font-medium border border-zinc-200 dark:border-zinc-700"
                    >
                      {hobby}
                    </span>
                  ))}
            ...
            <div className="flex justify-around gap-4 mt-6 pt-6 border-t border-zinc-100 dark:border-zinc-800">
