    ...
    <div className="flex flex-col min-h-screen bg-background font-sans">
      ...
      <section className="relative w-full pt-12 pb-24 md:pt-24 md:pb-32 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative w-full h-[400px] md:h-[550px] rounded-3xl overflow-hidden shadow-2xl border border-border">
            <Image
              src="/background.png"
              alt="Abstract background representing connection"
              fill
              priority
            ...
            {/* Gemini Watermark Annotation */}
            <div className="absolute bottom-4 right-4 text-[10px] text-white/80 bg-black/40 px-2 py-1 rounded backdrop-blur-md">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
            ...
            <div className="flex flex-col items-center text-center group">
              ...
              <h3 className="text-xl font-medium mb-3 text-foreground">Vibe Check & Match</h3>
              <p className="text-muted-foreground leading-relaxed">
                Swipe through verified student profiles. Filter by graduation year, major, and living habits like cleanliness, quiet hours, and pet preferences.
              </p>
            </div>
      ...
      {/* Bottom CTA Section */}
      <section className="bg-zinc-50 dark:bg-zinc-900/50 py-24 mb-10 w-full text-center">
